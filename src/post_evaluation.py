...
def load_finetuned_embeddings(eval_folder):
    embeddings = {}
    for person in os.listdir(eval_folder):
        ...
        for img_file in os.listdir(person_path):
            ...
            emb = get_finetuned_embedding(img_path)
            if emb is not None:
...
def evaluate_finetuned_model(eval_folder):
    print("🔍 Extracting fine-tuned embeddings...")
    embeddings = load_finetuned_embeddings(eval_folder)
